                        ...
                        <form action="{{ route('job.index') }}" method="GET">
                            ...
                            <div class="mb-4">
                                ...
                                @foreach($jobTypes as $jobType)
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" name="job_type[]" type="checkbox" value="{{ $jobType->id }}" id="job_type_{{ $jobType->id }}" {{ in_array($jobType->id, request('job_type', [])) ? 'checked' : '' }}>
                            ...
                            <div class="mb-4">
                                ...
                                <select name="experience" id="experience" class="form-control">
                                    ...
                                    @for ($i = 1; $i <= 10; $i++)
                                        <option value="{{ $i }} Years" {{ request('experience') == "{$i} Years" ? 'selected' : '' }}>{{ $i }} Year{{ $i > 1 ? 's' : '' }}</option>
                                    @endfor
                ...
                <div class="col-md-8 col-lg-9 ">
                    <div class="job_listing_area">
                        <div class="job_lists">
                                    ...
                                    <div class="col-md-4">
                                        <div class="card border-0 p-3 shadow mb-4">
                                            <div class="card-body">
                                                ...
                                                <p class="text-truncate">{{ $job->company_name }}</p>
                            ...
                            <div class="">
                                <div>
                                    {{ $jobs->appends(request()->query())->links() }} <!-- Giữ lại các tham số query -->
                                </div>
                            </div>
                        </div>
                    </div>
