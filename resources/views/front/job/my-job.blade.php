                    ...
                    <table class="table ">
                        ...
                        @foreach($jobs as $job)
                            <tr class="active">
                                ...
                                <td>{{ $applicantsCount[$job->id] ?? 0 }} Applications</td>
                                    ...
                                    <div class="action-dots float-end">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li><a class="dropdown-item" href="{{route('job.details',$job->id)}}"> <i class="fa fa-eye"
                                                                                                    aria-hidden="true"></i>
                                                    View</a></li>
                                            <li><a class="dropdown-item" href="{{ route('job.applicants', $job->id) }}"><i class="fa fa-edit"
                                                                                     aria-hidden="true"></i> Show applicants</a></li>
                                            <li>

                                            <li><a class="dropdown-item" href="{{route('job.edit',$job->id)}}"><i class="fa fa-edit"
